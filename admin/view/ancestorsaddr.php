...
<html>
    <head>
        ...
        <script>
            function check(id) {
                window.location = '../action/checkparent.php?id=' + id + '&type=addr';
            }
            function view(id) {
                window.location = 'chinaaddr.php?id=' + id;
            }
...
<!--            </ul>
        ...
        <div class=" col-xs-9">
            <center>
                <h1>ค้นหาที่อยู่บรรพบุรุษที่ประเทศจีนอัตโนมัติ</h1>
                <div class="row" style="margin-top: -3px">
                    <div class="col-xs-10 col-xs-offset-1 well">
                        <form class="form-horizontal" action="ancestorsaddr.php" method="Get" style="margin-left:-10px; margin-top: 10px">
                            <div class="row">
...
//                            $count = 1;
                                ...
                                $query = search_ancestorsaddr($data, $search_type);
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if ($person['CHINAHOUSE_ID'] == 0) {
                                                    ?>
                                                    <a style="color:white" class="mdi-maps-navigation" onClick="check('<?php echo $id; ?>')">ค้นหาที่อยู่บรรพบุรุษที่ประเทศจีน</a>    
                                                    <?php
                                                } else {
                                                    ?>
                                                    <a style="color:white" class="mdi-maps-flight" onClick="view('<?php echo $id; ?>')">เรียกดูที่อยู่บรรพบุรุษที่ประเทศจีน</a>   
                                                    <?php
                                                }
                                                ?>
                                            </td>
