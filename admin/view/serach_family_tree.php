            ...
            <center>
                ...
                <div class="row" style="margin-top: -3px">
                    <div class="col-xs-10 col-xs-offset-1 well">
                        <form class="form-horizontal" action="serach_family_tree.php" method="Get" style="margin-left:-10px; margin-top: 10px">
                            <div class="row">
                                ...
                                while ($datas = mysql_fetch_array($serachData)) {
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a style="color: white;" class="mdi-action-pageview"onClick="javascript:window.location.assign('family_tree_detail.php?id=<?php echo $id; ?>')">ดูรายละเอียด</a></td>                      
                                        </tr>
                                        <?php
                                        $count++;
                                    }
