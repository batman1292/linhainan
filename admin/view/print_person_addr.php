...
<!--            </ul>
        ...
        <div class="col-xs-9">
            <center>
                <h1>พิมพ์ข้อมูลที่อยู่รายบุคคล</h1>
                <div class="row" style="margin-top: -3px">
                    <div class="col-xs-10 col-xs-offset-1 well">
                        <form class="form-horizontal" action="print_person_addr.php" method="Get" style="margin-left:-10px; margin-top: 10px">
                            <div class="row">
                            ...
                            <div class="row" style="margin-top: 10px">
                                ...
                                <div class="col-xs-3">
                                    <input type="text" class="form-control" name="numprint" placeholder="กรอกจำนวนที่ต้องการพิม" >
                                </div>
                            </div>
                        ...
                        if (!$check) {
                            ...
                            <div class="row">
                                ...
                                <table class="table">
                                    ...
                                    <?php
//                            $count = 1;
                                    $urlquery_str = "data=$data&option=$search_type&numprint=$numprint&search=";
                                    ...
                                    while ($datas = mysql_fetch_array($serachData)) {
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a style="color: white;" class="mdi-action-print" onClick="javascript:window.open('../../print/person_addr.php?id=<?php echo $person['ID']; ?>&numprint=<?php echo $numprint; ?>', '', 'nenuber=no,toorlbar=no,location=no,scrollbars=no, status=no,resizable=no,width=800,height=650,top=0,left=150 ')">พิมพ์ที่อยู่</a></td>
