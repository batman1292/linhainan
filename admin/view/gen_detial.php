<html>
    ...
    connect_database();
    $gen_id = $_GET['gen_id'];
    $generations = get_gen_detial($gen_id);
    ...
    <body class="btn-danger">
        ...
        <div class="col-xs-9">
            <center>
                <div class="row">
                    <div class="row">
                        <h1>แผนผังรุ่น <?php echo $generation['GENERATION_NAME'] . ' ' . $generation['GENERATION_PINYIN'] . ' ' . $generation['GENERATION_TH']; ?> </h1>
                    </div>
                    <div class="row">
...
//                                    $person = get_per
                                    $query = get_generation_person($gen_id);
