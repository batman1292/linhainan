...
//                window.location = 'adding.php?code=' + code + '&department=' + department;
            ...
            function exportSQL() {
                window.location = '../../helper/export_sql.php';
            }
            function importSQL() {
                window.location = '../../helper/import_sql.php';
            }
            function submit() {
                document.getElementById("loading").style.display = "block"
                document.getElementById("importfile").submit();
            }
                ...
                <div class="row" style="margin-top: -3px">
                    <div class="col-xs-10 col-xs-offset-1 well">
                        ...
                        <div class="row" style="margin-top: 20px">
                            <div class="col-xs-12">
                                <a class="btn btn-primary" role="button" style="margin-top: 0px" onClick="exportSQL()">BACKUP ฐานข้อมูล</a>
                            </div>
                        </div>
                        <div class="row" style="margin-top: 20px">
                            <div class="col-xs-12">
                                <form name="importfile" action="../../helper/import_sql.php" method="POST"  enctype="multipart/form-data">
                                    <input type="file" name="sqlfile" id="sqlfile" data-input="false"  class="filestyle" data-buttonText="นำเข้าข้อมูลที่ backup" value="fasfs" onchange="submit();">
                                </form>
                            </div>
                        </div>
                    </div> 
