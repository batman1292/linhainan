    ...
    <body class="btn-danger">
        ...
        <div class=" col-sm-12">
            ...
            <div class="well">
                                ...
                                <table class="table" style="color:black">
                                    ...
                                    while ($gen_other = mysql_fetch_assoc($gen_others)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a onClick="javascript:window.location.assign('setup_gen_menu_form.php?gen_type=2&action=2&id=<?php echo $id; ?>')">แก้ไข</a></td> 
                                            <td><a onclick="del('<?php echo $gen_other['ID']; ?>', '<?php echo $gen_other['GENERATION_NAME']; ?>')">ลบ</a></td>
                                        </tr>    
                                        <?php
                                    }
                                    ?>
                                ...
                                <table class="table" style="color:black">
                                    ...
                                    while ($gen_other = mysql_fetch_assoc($gen_others)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $gen_other['GENERATION_PINYIN']; ?></td>
                                            <td><?php echo $gen_other['GENERATION_TH']; ?></td>
                                            <td><a onClick="javascript:window.location.assign('setup_gen_menu_form.php?gen_type=1&action=2&id=<?php echo $id; ?>')">แก้ไข</a></td> 
                                            <td><a onclick="del('<?php echo $gen_other['ID']; ?>', '<?php echo $gen_other['GENERATION_NAME']; ?>')">ลบ</a></td>
                                        </tr>    
                                        <?php
                                    }
                ...
                <div class="row">
                    <fieldset class="scheduler-border">
                        <legend class="scheduler-border">อื่นๆ
                            <a onClick="javascript:window.location.assign('setup_gen_menu_form.php?gen_type=3&action=1')">เพิ่มข้อมูล</a>
                        </legend>
                        <?php
                        $gen_others = get_gen_by_type(3);
                        $check = mysql_fetch_assoc($gen_others);
                        if ($check) {
                                ?>
                                <table class="table" style="color:black">
...
//                                        print_r($gen_other);
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $gen_other['GENERATION_PINYIN']; ?></td>
                                            <td><?php echo $gen_other['GENERATION_TH']; ?></td>
                                            <td><a onClick="javascript:window.location.assign('setup_gen_menu_form.php?gen_type=3&action=2&id=<?php echo $id; ?>')">แก้ไข</a></td> 
                                            <td><a onclick="del('<?php echo $gen_other['ID']; ?>', '<?php echo $gen_other['GENERATION_NAME']; ?>')">ลบ</a></td>
                                        </tr>    
                                        <?php
                                    }
