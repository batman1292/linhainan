        ...
        <div class="bs-component">
            <form class="form-horizontal well" action="../action/edit_parent_person.php?id=<?php echo $id; ?>" method="Post" style="margin:10 10 10 10" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <input type="text" list="list_parent" class="parent_list form-control" name="parent" value="<?php echo get_person_name_string($person['MOTHER_ID']).' '.  get_person_surname_string($person['MOTHER_ID']) ?>" />
                    ...
                    <div class="col-xs-3" style="margin-top: 5px;">
                        <input type="radio" name="parent_status" value="1" <?php if(get_status($person['MOTHER_ID'])==1){echo "checked";}?> >ยังมีชีวิตอยู่
                        <input type="radio" name="parent_status" value="2" <?php if(get_status($person['MOTHER_ID'])==2){echo "checked";}?>  >เสียชีวิต
