    ...
    <body>
        <div class="bs-component">
            ...
            <div id="print_div">
                ...
                ?>
                <div id="pageHeader">
                    <hr style="margin-top:0px; margin-bottom: -5px;" border="1">
                    <div class="row">
                        <div class="col-xs-12"> <u><b>1)ข้อมูลส่วนตัว</b></u>  </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-1">
                            ID
                    ...
                    <hr style="margin-top:0px; margin-bottom: -5px;" border="1">
                    <div class="row">
                        <div class="col-xs-12"> <u><b>2)ข้อมูลการติดต่อ</b></u>  </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-2">
                            โทรศัพท์บ้าน
                    ...
                    <hr style="margin-top:0px; margin-bottom: -5px;" border="1">
                    <div class="row">
                        <div class="col-xs-12"> <u><b>3) อาชีพ/ธุรกิจหลัก</b></u>  </div>
                    </div>
                    <!--echo "ที่อยู่";-->
                    <div class="row">
                        <div class="col-xs-1">
                    ...
                    <hr style="margin-top:0px; margin-bottom: -5px;" border="1">
                    <div class="row">
                        <div class="col-xs-12"> <u><b>4) บิดา-มารดา</b></u>  </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-3">
                            ชื่อ-สกุลมารดา
                    ...
                    <hr style="margin-top:0px; margin-bottom: -5px;" border="1">
                    <div class="row">
                        <div class="col-xs-12"> <u><b>5) ข้อมูลที่อยู่บรรพบุรุษที่ประเทศจีน</b></u>  </div>
                    </div>
                    ...
                    <hr style="margin-top:0px; margin-bottom: -5px;" border="1">
                    <div class="row">
                        <div class="col-xs-12"> <u><b>6) ข้อมูลพี่น้องร่วมบิดามารดา</b></u>  </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-4">
                            ชื่อ-สกุลพี่น้อง
                    ...
                    <hr style="margin-top:0px; margin-bottom: -5px;" border="1">
                    <div class="row">
                        <div class="col-xs-12"><u><b>7) ข้อมูลบุตรธิดา</b></u></div>
                    </div>
                    <div class="row">
                        <div class="col-xs-4">
                            ชื่อ-สกุลบุตรธิดา
...
//                $all_persons = get_person_detial(355);
                while ($all_person = mysql_fetch_row($all_persons)) {
                    $id = $all_person[0];
...
//                        print_r($chinahouse);
                    ...
                    <div id="content">
                        <!--<hr style="margin-top:0px; margin-bottom: -5px;" border="1">-->
                        <div class="row">
                            <div class="col-xs-12"> <b><u>1)ข้อมูลส่วนตัว</u> </b></div>
                        </div>
                        <div class="row">
                            <div class="col-xs-1">
                                <?php echo $id; ?>
...
//                    echo "<br/>";
                        ...
                        <hr style="margin-top:0px; margin-bottom: -5px;" border="1">
                            <div class="row">
                                <div class="col-xs-12"> <b><u>2) ข้อมูลการติดต่อ</u> </b></div>
                            </div>
                        <div class="row">
                            <div class="col-xs-2">
...
//                    echo "<br/>";
                        ...
                        <hr style="margin-top:0px; margin-bottom: -5px;" border="1">
                    <div class="row">
                        <div class="col-xs-12"> <b><u>3) อาชีพ/ธุรกิจหลัก</u> </b></div>
                    </div>
                        <div class="row">
                            <div class="col-xs-1">
                                <?php
...
//                    echo "<br/>";
                        ...
                        <hr style="margin-top:0px; margin-bottom: -5px;" border="1">
                    <div class="row">
                        <div class="col-xs-12"> <b><u>4) ข้อมูลบิดา-มารดา</u> </b></div>
                    </div>
                        <div class="row">
                            <div class="col-xs-3">
...
//                    echo "<br/>";
                        ...
                        <hr style="margin-top:0px; margin-bottom: -5px;" border="1">
                    <div class="row">
                        <div class="col-xs-12"> <b><u>5) ข้อมูลที่อยู่บรรพบุรุษที่ประเทศจีน</u> </b></div>
                    </div>
                        <div class="row">
                            <div class="col-xs-4">
...
//                    echo $chinahouse_province_string;
                        ...
                        <hr style="margin-top:0px; margin-bottom: -5px;" border="1">
                    <div class="row">
                        <div class="col-xs-12"> <b><u>6) ข้อมูลพี่น้องร่วมบิดามารดา</u> </b></div>
                    </div>    
                        <?php
...
//                            }
                        ...
                        ?>
                        <hr style="margin-top:0px; margin-bottom: -5px; color: black;">
                    <div class="row">
                        <div class="col-xs-12"> <b><u>7) ข้อมูลบุตร-ธิดา</u> </b></div>
                    </div>
                        <hr style="margin-top:0px; margin-bottom: -5px; color: black;">
                    </div>
                    <?php
